...
def detectShush(frame, location, ROI, cascade):
    mouths = cascade.detectMultiScale(ROI, 1.23, 15, 0, (25, 20))
...
def detect(frame, faceCascade, mouthsCascade):
    ...
    gray_frame = cv2.bilateralFilter(gray_frame,10,20,20)
    faces = faceCascade.detectMultiScale(
        gray_frame, 1.11, 8, 0 | cv2.CASCADE_SCALE_IMAGE, (35,40))
    detected = 0
